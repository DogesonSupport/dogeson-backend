...
import com.highest.base.http.httpclient.extended.NoopCookieSpecProvider;
...
public class SiteConfig {
    ...
    private RedirectMode redirectMode = RedirectMode.FOLLOW_ALL;
    private int maxRequestRetryCount = 3;
    ...
    public SiteConfig setMaxRequestRetryCount(int maxRequestRetryCount) {
